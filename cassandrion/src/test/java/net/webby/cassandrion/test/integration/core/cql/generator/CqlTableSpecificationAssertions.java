...
import net.webby.cassandrion.core.cql.spec.ColumnSpecification;
import net.webby.cassandrion.core.cql.spec.TableDescriptor;
import net.webby.cassandrion.core.cql.spec.TableOption;
import net.webby.cassandrion.core.cql.spec.TableOption.CachingOption;
