 ...
 */
package net.webby.cassandrion.test.unit.core.cql;

import static net.webby.cassandrion.core.cql.CqlStringUtils.isQuotedIdentifier;
import static net.webby.cassandrion.core.cql.CqlStringUtils.isUnquotedIdentifier;
