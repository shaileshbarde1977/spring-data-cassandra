...
public class CassandraDataConversionTests {
	...
	public void basicNullsTest() {
		...
		cassandraOperations.execute("insert into test.basic_types_table (id) values ('nulls')", null);
	...
	public void basicValuesReadTest() throws Exception {
		...
		cassandraOperations.execute(String.format(
	...
	public void collectionsNullsTest() {
		...
		cassandraOperations.execute("insert into test.collection_types_table (id) values ('nulls')", null);
	...
	public void embeddedIdReadTest() {
		...
		cassandraOperations.execute("insert into test.embedded_id_table (partitionkey, clusteringkey, proptext) "
