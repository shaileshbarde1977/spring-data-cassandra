...
public interface CassandraOperations {
	 ...
	 */
	void execute(String cql, ExecuteOptions optionsOrNull);
	 ...
	 * @param optionsOrNull Execute Options Object if exists
	 */
	void executeNonstop(String cql, int timeoutMls, ExecuteOptions optionsOrNull) throws TimeoutException;
	 ...
	 * @param optionsOrNull Execute Options Object if exists
	 */
	void executeAsync(String cql, ExecuteOptions optionsOrNull);
