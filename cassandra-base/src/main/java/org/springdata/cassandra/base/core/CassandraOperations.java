...
public interface CassandraOperations {
	 ...
	 * @return
	 */
	<T> T select(String cql, ResultSetExtractor<T> rse, QueryOptions optionsOrNull);
	 ...
	 */
	ResultSetFuture selectAsynchronously(String cql, QueryOptions optionsOrNull);
	 ...
	 * @return Iterator of <T> generated by the RowMapper <<<<<<< HEAD =======
	 * @throws DataAccessException >>>>>>> branch 'master' of https://github.com/SpringData/spring-data-cassandra.git
	 */
	 ...
	 */
	<T> T select(String cql, PreparedStatementBinder psb, ResultSetExtractor<T> rse, QueryOptions optionsOrNull);
	 ...
	 * @param optionsOrNull Query Options Object if exists
	 */
	void select(String cql, PreparedStatementBinder psb, RowCallbackHandler rch, QueryOptions optionsOrNull);
	 ...
	 * @param optionsOrNull Query Options Object if exists
	 * @return Iterator of <T> for each Row returned from the Query.
	 */
	<T> Iterator<T> select(String cql, PreparedStatementBinder psb, RowMapper<T> rowMapper, QueryOptions optionsOrNull);
	 ...
	 */
	<T> T select(PreparedStatementCreator psc, ResultSetExtractor<T> rse, QueryOptions optionsOrNull);
	 ...
	 * @param optionsOrNull Query Options Object if exists
	 */
	void select(PreparedStatementCreator psc, RowCallbackHandler rch, QueryOptions optionsOrNull);
	 ...
	 */
	<T> Iterator<T> select(PreparedStatementCreator psc, RowMapper<T> rowMapper, QueryOptions optionsOrNull);
	 ...
	 * @return Type <T> which is the output of the ResultSetExtractor
	 */
	<T> T select(PreparedStatementCreator psc, PreparedStatementBinder psbOrNull, ResultSetExtractor<T> rse,
	 ...
	 * @return Type <T> which is the output of the ResultSetExtractor
	 */
	void select(PreparedStatementCreator psc, PreparedStatementBinder psbOrNull, RowCallbackHandler rch,
			QueryOptions optionsOrNull);
	 ...
	 * @param rowMapper The implementation for mapping each Row returned.
	 * @param optionsOrNull The Query Options Object if exists
	 * @return Iterator <T> which is the output of the ResultSetExtractor
	 */
	<T> Iterator<T> select(PreparedStatementCreator psc, PreparedStatementBinder psbOrNull, RowMapper<T> rowMapper,
			QueryOptions optionsOrNull);
