...
import net.webby.cassandrion.data.util.CassandrionNamingUtils;
 ...
 * @author Alex Shvid
 */
public class BasicCassandrionPersistentEntity<T> extends BasicPersistentEntity<T, CassandraPersistentProperty> implements
	...
	/**
	 * Creates a new {@link BasicCassandrionPersistentEntity} with the given {@link TypeInformation}. Will default the table
	 * name to the entities simple type name.
	 * 
	 * @param typeInformation
	 */
	public BasicCassandrionPersistentEntity(TypeInformation<T> typeInformation) {
		...
		String fallback = CassandrionNamingUtils.getPreferredTableName(rawType);
