...
import net.webby.cassandrion.data.config.CompressionType;
import net.webby.cassandrion.data.config.PoolingOptionsConfig;
import net.webby.cassandrion.data.config.SocketOptionsConfig;
...
public class CassandrionClusterFactoryBean implements FactoryBean<Cluster>, InitializingBean, DisposableBean,
