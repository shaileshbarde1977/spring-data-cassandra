 ...
 */
package org.springdata.cassandra.base.support;

import org.springdata.cassandra.base.support.exception.CassandraAuthenticationException;
import org.springdata.cassandra.base.support.exception.CassandraConnectionFailureException;
import org.springdata.cassandra.base.support.exception.CassandraInsufficientReplicasAvailableException;
import org.springdata.cassandra.base.support.exception.CassandraInternalException;
import org.springdata.cassandra.base.support.exception.CassandraInvalidConfigurationInQueryException;
import org.springdata.cassandra.base.support.exception.CassandraInvalidQueryException;
import org.springdata.cassandra.base.support.exception.CassandraKeyspaceExistsException;
import org.springdata.cassandra.base.support.exception.CassandraQuerySyntaxException;
import org.springdata.cassandra.base.support.exception.CassandraReadTimeoutException;
import org.springdata.cassandra.base.support.exception.CassandraTableExistsException;
import org.springdata.cassandra.base.support.exception.CassandraTraceRetrievalException;
import org.springdata.cassandra.base.support.exception.CassandraTruncateException;
import org.springdata.cassandra.base.support.exception.CassandraTypeMismatchException;
import org.springdata.cassandra.base.support.exception.CassandraUnauthorizedException;
import org.springdata.cassandra.base.support.exception.CassandraUncategorizedException;
import org.springdata.cassandra.base.support.exception.CassandraWriteTimeoutException;
