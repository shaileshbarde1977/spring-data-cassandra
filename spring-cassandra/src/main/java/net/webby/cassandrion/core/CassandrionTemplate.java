...
import net.webby.cassandrion.core.query.ConsistencyLevelResolver;
...
import net.webby.cassandrion.core.query.RetryPolicyResolver;
import net.webby.cassandrion.support.CassandraAccessor;
 ...
 * @author Alex Shvid
 */
public class CassandrionTemplate extends CassandraAccessor implements CassandrionOperations {
	 ...
	 */
	public CassandrionTemplate(Session session) {
		setSession(session);
		afterPropertiesSet();
	}
