 ...
 */
package net.webby.cassandrion.core.cql.spec;

import static net.webby.cassandrion.core.KeyPart.CLUSTERING;
import static net.webby.cassandrion.core.KeyPart.PARTITION;
import static net.webby.cassandrion.core.Ordering.ASCENDING;
import static net.webby.cassandrion.core.cql.CqlStringUtils.checkIdentifier;
import static net.webby.cassandrion.core.cql.CqlStringUtils.identifize;
import static net.webby.cassandrion.core.cql.CqlStringUtils.noNull;
import net.webby.cassandrion.core.KeyPart;
import net.webby.cassandrion.core.Ordering;
