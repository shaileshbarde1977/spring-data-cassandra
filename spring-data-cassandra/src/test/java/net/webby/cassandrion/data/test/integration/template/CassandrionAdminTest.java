...
public class CassandrionAdminTest {

	@Autowired
	private CassandrionOperations cassandraTemplate;

	@Mock
	ApplicationContext context;

	private static Logger log = LoggerFactory.getLogger(CassandrionAdminTest.class);
