...
import net.webby.cassandrion.data.core.CassandrionClusterFactoryBean;
...
public class CassandrionClusterParser extends AbstractSimpleBeanDefinitionParser {

	@Override
	protected Class<?> getBeanClass(Element element) {
		return CassandrionClusterFactoryBean.class;
	}
	...
	protected String resolveId(Element element, AbstractBeanDefinition definition, ParserContext parserContext)
		...
		return StringUtils.hasText(id) ? id : ConfigConstants.CASSANDRION_CLUSTER;
	}
