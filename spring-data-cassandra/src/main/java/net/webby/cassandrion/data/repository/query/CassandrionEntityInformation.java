 ...
 */
package net.webby.cassandrion.data.repository.query;
 ...
 * 
 */
public interface CassandrionEntityInformation<T, ID extends Serializable> extends EntityInformation<T, ID> {
