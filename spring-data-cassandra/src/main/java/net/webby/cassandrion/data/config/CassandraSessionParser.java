...
public class CassandraSessionParser extends AbstractSimpleBeanDefinitionParser {
	...
	protected Class<?> getBeanClass(Element element) {
		return CassandrionSessionFactoryBean.class;
	}
	...
	protected String resolveId(Element element, AbstractBeanDefinition definition, ParserContext parserContext)
		...
		return StringUtils.hasText(id) ? id : ConfigConstants.CASSANDRION_SESSION;
	}
	...
	protected void doParse(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
		...
		if (!StringUtils.hasText(clusterRef)) {
			clusterRef = ConfigConstants.CASSANDRION_CLUSTER;
		}
